...
def create_app():
    ...
    try:
        ...
        try:
            from minimal_solutions.minecraft_cleaner.minecraft_cleaner_api import api_bp as minecraft_cleaner_api_bp
            app.register_blueprint(minecraft_cleaner_api_bp)
        except ImportError:
            pass

        try:
            from minimal_solutions.minecraft_cleaner.minecraft_cleaner_ui import ui_bp as minecraft_cleaner_ui_bp
            app.register_blueprint(minecraft_cleaner_ui_bp)
        except ImportError:
            pass
