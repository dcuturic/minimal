...
def render_seo_builder_ui():
    return Div(
        # Hero Section
        Div(
            H2("SEO Builder", cls="text-3xl font-bold text-white mb-2 tracking-tight"),
            P("SEO Builder baut SEO-Daten als kleine UI-Demo und stellt dieselbe Funktion als API-Schnittstelle bereit.", cls="text-gray-400 text-sm"),
            cls="mb-8"
        ),
        ...
        Div(
            ...
            Div(
                Form(
                    ...
                    Div(
                        ...
                        Textarea(
                            name="topic", 
                            placeholder="Gib hier das Thema oder den Inhalt ein...", 
                    ...
                    Div(
                        ...
                        Input(
                            type="text",
                            name="target",
                            placeholder="z.B. Google, Blog, Landing Page",
                    ...
                    Div(
                        ...
                        Input(
                            type="text",
                            name="options",
                            placeholder="z.B. keywords, meta_tags (kommagetrennt)",
                            cls="w-full bg-[#0a0a0f] border border-gray-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all shadow-inner"
                        ),
                        cls="mb-8"
                    ),
            ...
            Div(
                ...
                Div(
                    ...
                    P("Generiere Daten...", cls="text-gray-400 text-sm font-medium tracking-wide animate-pulse"),
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("die generierten SEO-Daten zu sehen.", cls="text-gray-500 text-sm"),
        ...
        Div(
            ...
            P("Du kannst den SEO Builder auch per API ansprechen. Hier ist ein Beispiel für Request und Response:", cls="text-gray-400 mb-4"),
            Div(
                Div(
    ...
    "keywords": ["seo", "builder", "demo"]
        ...
        Script(r"""
            document.addEventListener('DOMContentLoaded', function() {
                const form = document.getElementById('seo-builder-form');
                ...
                if(form) {
                    form.addEventListener('submit', async function(e) {
                        ...
                        try {
                            const response = await fetch('/api/minimal-solutions/seo_builder', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json'
                                },
                            ...
                            formattedResult.querySelector('.download-btn').addEventListener('click', function() {
                                ...
                                if (typeof window.triggerDownload === 'function') {
                                    window.triggerDownload(resultText, ext, 'seo_builder_data', this);
                                } else {
                                    ...
                                    a.href = url;
                                    a.download = `seo_builder_data.${ext}`;
