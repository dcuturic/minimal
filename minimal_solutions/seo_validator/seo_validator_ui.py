...
def render_seo_validator_ui():
    return Div(
        # Hero Section
        Div(
            H2("SEO Validator", cls="text-3xl font-bold text-white mb-2 tracking-tight"),
            P("Validiert SEO-Daten als kleine UI-Demo und stellt dieselbe Funktion als API-Schnittstelle bereit.", cls="text-gray-400 text-sm"),
            cls="mb-8"
        ),
        ...
        Div(
            ...
            Div(
                ...
                Div(
                    ...
                    P("Validiere Daten...", cls="text-gray-400 text-sm font-medium tracking-wide animate-pulse"),
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("die Validierungs-Ergebnisse zu sehen.", cls="text-gray-500 text-sm"),
        ...
        Div(
            ...
            P("Du kannst den SEO Validator auch per API ansprechen. Hier ist ein Beispiel für Request und Response:", cls="text-gray-400 mb-4"),
            Div(
                Div(
      ...
      "target": "Google"
        ...
        Script(r"""
            document.addEventListener('DOMContentLoaded', function() {
                const form = document.getElementById('seo-validator-form');
                ...
                if(form) {
                    form.addEventListener('submit', async function(e) {
                        ...
                        try {
                            const response = await fetch('/api/minimal-solutions/seo_validator', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json'
                                },
                            ...
                            formattedResult.querySelector('.download-btn').addEventListener('click', function() {
                                ...
                                if (typeof window.triggerDownload === 'function') {
                                    window.triggerDownload(resultText, ext, 'seo_validator_data', this);
                                } else {
                                    ...
                                    a.href = url;
                                    a.download = `seo_validator_data.${ext}`;
