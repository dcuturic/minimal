...
def render_seo_preview_ui():
    return Div(
        # Hero Section
        Div(
            H2("SEO Preview", cls="text-3xl font-bold text-white mb-2 tracking-tight"),
            P("Zeigt eine Vorschau für SEO-Daten als kleine UI-Demo und stellt dieselbe Funktion als API-Schnittstelle bereit.", cls="text-gray-400 text-sm"),
            cls="mb-8"
        ),
        ...
        Div(
                ...
                Form(
                    ...
                    Div(
                        ...
                        Input(
                            type="text",
                            name="options",
                            placeholder="z.B. strict, verbose (kommagetrennt)",
                            cls="w-full bg-[#0a0a0f] border border-gray-800 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all shadow-inner"
                        ),
                        cls="mb-8"
                    ),
            ...
            Div(
                ...
                Div(
                    ...
                    P("Generiere Vorschau...", cls="text-gray-400 text-sm font-medium tracking-wide animate-pulse"),
                ...
                Div(
                    ...
                    Div(
                        ...
                        P("die Vorschau-Ergebnisse zu sehen.", cls="text-gray-500 text-sm"),
        ...
        Div(
            ...
            P("Du kannst die SEO Preview auch per API ansprechen. Hier ist ein Beispiel für Request und Response:", cls="text-gray-400 mb-4"),
            Div(
                Div(
                    H4("Request", cls="text-sm font-semibold text-gray-300 mb-2 uppercase tracking-wider"),
                    Pre(
                        Code(
                            """POST /api/minimal-solutions/seo_preview
      ...
      "target": "Google"
        ...
        Script(r"""
            document.addEventListener('DOMContentLoaded', function() {
                const form = document.getElementById('seo-preview-form');
                ...
                if(form) {
                    form.addEventListener('submit', async function(e) {
                        ...
                        try {
                            const response = await fetch('/api/minimal-solutions/seo_preview', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json'
                                },
                            ...
                            formattedResult.querySelector('.download-btn').addEventListener('click', function() {
                                ...
                                if (typeof window.triggerDownload === 'function') {
                                    window.triggerDownload(resultText, ext, 'seo_preview_data', this);
                                } else {
                                    ...
                                    a.href = url;
                                    a.download = `seo_preview_data.${ext}`;
