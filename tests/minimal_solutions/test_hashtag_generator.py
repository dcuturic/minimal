...
from minimal_solutions.hashtag_generator.hashtag_generator_api import api_bp
...
class TestHashtagGenerator(unittest.TestCase):
    ...
    def test_happy_path(self):
        ...
        response = self.client.post('/api/minimal-solutions/hashtag_generator', json={
            "topic": "Python",
            "audience": "Developers",
            "count": 5
        })
        ...
        self.assertEqual(len(result['list']), 5)
        self.assertIn("#Python", result['list'])
        self.assertIn("#Developers", result['list'])
