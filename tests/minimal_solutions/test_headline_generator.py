...
from minimal_solutions.headline_generator.headline_generator_api import api_bp
...
class TestHeadlineGenerator(unittest.TestCase):
    ...
    def test_happy_path(self):
        ...
        response = self.client.post('/api/minimal-solutions/headline_generator', json={
        ...
        self.assertIn('headlines', data.get('data', {}))
        self.assertEqual(len(data['data']['headlines']), 5)
