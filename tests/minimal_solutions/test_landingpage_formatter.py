...
from minimal_solutions.landingpage_formatter.landingpage_formatter_api import api_bp

class TestLandingpageFormatter(unittest.TestCase):
    def setUp(self):
        self.app = create_app()
        try:
    ...
    def test_happy_path(self):
        ...
        response = self.client.post('/api/minimal-solutions/landingpage_formatter', json={
