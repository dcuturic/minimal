...
from minimal_solutions.e_mail_betreff_generator.e_mail_betreff_generator_api import api_bp

class TestEMailBetreffGenerator(unittest.TestCase):
    def setUp(self):
        self.app = create_app()
    ...
    def test_happy_path(self):
        ...
        response = self.client.post('/api/minimal-solutions/e_mail_betreff_generator', json={
            "topic": "Neuer Produktlaunch",
        ...
        self.assertIn('subjects', data.get('data', {}))
    ...
    def test_invalid_input(self):
        ...
        response = self.client.post('/api/minimal-solutions/e_mail_betreff_generator', json={
            ...
            "tone": "   "    # Invalid value (empty after strip)
        })
        self.assertEqual(response.status_code, 400)
        data = json.loads(response.data)
        self.assertFalse(data.get('success'))
