...
from minimal_solutions.json_formatter.json_formatter_api import api_bp
...
class TestJsonFormatter(unittest.TestCase):
    ...
    def test_happy_path(self):
        ...
        response = self.client.post('/api/minimal-solutions/json_formatter', json={
            "json_text": "{\"key\":\"value\"}",
            "indent": 2
        })
        ...
        self.assertIn('formatted_json', data.get('data', {}))
        self.assertIn('{\n  "key": "value"\n}', data['data']['formatted_json'])
